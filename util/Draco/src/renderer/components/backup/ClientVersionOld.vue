<template>
    <div>
      <mu-content-block>
        ...
        <mu-button label="修改版本号" class="demo-snackbar-button" @click="modifyEdition" primary/>
        <mu-button label="编译JS代码" class="demo-snackbar-button" @click="compileCode" primary/>
        <mu-button label="生成版本" class="demo-snackbar-button" @click="generateEdition" primary/>
        <mu-divider/>
        <mu-content-block>
        ...
        <mu-button label="压缩zip工程" class="demo-snackbar-button" @click="zipProject" primary/>
        <mu-button label="传输zip工程" class="demo-snackbar-button" @click="transferProject" primary/>
        <mu-button label="解压远程zip工程" class="demo-snackbar-button" @click="unzipProject" primary/>
        <mu-button label="执行python文件" class="demo-snackbar-button" @click="runPython" primary/>
    </div>
</template>
  ...
  methods: {
    modifyEdition() {
      if (!this.newEdition || this.newEdition == "") {
        ipcRenderer.send("client_show_snack", "新版本号不能为空");
        return;
      }

      if (this.newEdition < this.oldEdition) {
        ipcRenderer.send("client_show_snack", "新版本号过旧");
        return;
      }
