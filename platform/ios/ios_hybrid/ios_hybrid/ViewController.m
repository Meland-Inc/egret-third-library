...
- (void)viewDidLoad {
    ...
    //[[UIApplication sharedApplication] setIdleTimerDisabled:YES];//屏幕常亮 看引擎自己有没有改 先注释
    ...
    //微端模式 走url
    //[EgretWebViewLib startGame:@"http://47.107.73.43/web/release/index.html" SuperView:self.view];
    
    //全量包模式 走本地
    [EgretWebViewLib startLocalServerFromResource];
    [EgretWebViewLib startGame:@"game/index.html" SuperView:self.view];
